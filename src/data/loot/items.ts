...
export interface LootItem extends LootItemData {
...
export const ITEMS_DATA: LootItemData[] = [
  ...
  {roll: 34, name: "Box of Many Goods", description: "Once per long rest, you can open this small box and roll a d12. On a result of 1–6, it's empty. On a result of 7–10, it contains one random common consumable. On a result of 11–12, it contains two random common consumables."},
...
export const RARITY_RANGES = {
  common: { min: 1, max: 12 },
  uncommon: { min: 13, max: 24 },
  rare: { min: 25, max: 36 },
  legendary: { min: 37, max: 48 }
} as const

export const RARITY_DICE_COUNTS = {
  common: [1, 2],
  uncommon: [2, 3],
  rare: [3, 4],
  legendary: [4, 5]
