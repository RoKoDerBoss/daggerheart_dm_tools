import { LootItemData } from './items'

export const CONSUMABLES_DATA: LootItemData[] = [
  ...
  {roll: 41, name: "Sun Tree Sap", description: "Consume this sap to roll a d6. On a result of 5–6, clear 2 HP. On a result of 2–4, clear 3 Stress. On a result of 1, see through the veil of death and return changed, gaining one scar."},
  ...
  {roll: 53, name: "Shrinking Potion", description: "You can drink this potion to halve your size until you choose to drop this form or your next rest. While in this form, you have a +2 bonus to Agility and a −1 penalty to your Proficiency."},
